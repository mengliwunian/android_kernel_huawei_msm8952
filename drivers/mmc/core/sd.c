...
static const struct mmc_fixup sd_sdr104_fixups[] = {
	/* Disable SD SDR104 feature for special card (ov card)*/
	MMC_FIXUP(CID_NAME_ANY, 0x89, 0x0302, add_quirk_sd_for_sdr104,
		SD_MODE_UHS_SDR104),
	MMC_FIXUP(CID_NAME_ANY, 0x9c, 0x534f, add_quirk_sd_for_sdr104,
		SD_MODE_UHS_SDR104),
	END_FIXUP
};
/*
...
static int mmc_read_switch(struct mmc_card *card)
{
	...
	if (card->scr.sda_spec3) {
		...
		mmc_fixup_device(card, sd_sdr104_fixups);
