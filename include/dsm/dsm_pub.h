...
#define DSM_GPU_PAGE_FAULT_NO			(20151)
#define DSM_GPU_SNAPSHOT_ERROR_NO			(20152)
...
#define DSM_FINGERPRINT_WAIT_FOR_FINGER_ERROR_NO	(DSM_FINGERPRINT_BASE_ERROR)
#define DSM_FINGERPRINT_CAPTURE_IMAGE_ERROR_NO		(DSM_FINGERPRINT_BASE_ERROR+1)
#define DSM_FINGERPRINT_IDENTIFY_ERROR_NO			(DSM_FINGERPRINT_BASE_ERROR+2)
#define DSM_FINGERPRINT_TEST_DEADPIXELS_ERROR_NO	(DSM_FINGERPRINT_BASE_ERROR+3)
#define DSM_FINGERPRINT_ENROLL_ERROR_NO				(DSM_FINGERPRINT_BASE_ERROR+4)
#define DSM_FINGERPRINT_REMOVE_TEMPLATE_ERROR_NO	(DSM_FINGERPRINT_BASE_ERROR+5)
#define DSM_FINGERPRINT_ENUMERATE_ERROR_NO			(DSM_FINGERPRINT_BASE_ERROR+6)
#define DSM_FINGERPRINT_MODULE_OPEN_ERROR_NO		(DSM_FINGERPRINT_BASE_ERROR+7)
#define DSM_FINGERPRINT_PROBE_FAIL_ERROR_NO			(DSM_FINGERPRINT_BASE_ERROR+8)
#define DSM_FINGERPRINT_DIFF_DEADPIXELS_ERROR_NO	(DSM_FINGERPRINT_BASE_ERROR+9)
#define DSM_FINGERPRINT_MANY_DEADPIXELS_ERROR_NO	(DSM_FINGERPRINT_BASE_ERROR+10)
...
enum DSM_SENSOR_ERR_TYPES {
	...
	/* for monitor aps sensor 21108 21109 21110 21111 21112 21113 21114.... */
	...
	DSM_LPS_INSTANT_POWER_OFF_ERROR,
